...
<aside class="w-64 bg-[#0a0a0c] border-r border-[#eab308]/20 flex flex-col h-full overflow-y-auto">
    ...
    <nav class="flex-1 py-4 px-3 space-y-1">
        ...
        <a href="{{ route('profile.show') }}" class="sidebar-link {{ request()->routeIs('profile') ? 'active' : '' }} py-2.5 px-3 rounded-lg flex items-center gap-3 text-gray-300 hover:text-[#eab308] transition">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @if(Auth::user()->hasRole('financeiro') || Auth::user()->isAdmin())
            ...
            <a href="{{ route('faturas.index') }}" class="sidebar-link py-2.5 px-3 rounded-lg flex items-center gap-3 text-gray-300 hover:text-[#eab308] transition ml-6">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                </svg>
                <span>Faturas</span>
            </a>
            <a href="{{ route('pagamentos.index') }}" class="sidebar-link py-2.5 px-3 rounded-lg flex items-center gap-3 text-gray-300 hover:text-[#eab308] transition ml-6">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
